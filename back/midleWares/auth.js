...
module.exports = (req, res, next) => {
    ...
    try{
        ...
        if(!token){
            ...
            res.status(401).json({ message: "mot de passe incorrect ou mot de passe incorrect" });
            ...
            dans la requête cest informations pourront être utilisées dans les routes qui nécessitent une authentification
            */
            req.auth ={
